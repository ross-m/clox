...
typedef enum
{
	...
	// keywords
	TOKEN_AND, TOKEN_CLASS, TOKEN_ELSE, TOKEN_FALSE, TOKEN_TRUE,TOKEN_FOR, 
	TOKEN_FUN, TOKEN_IF, TOKEN_NIL, TOKEN_OR, TOKEN_PRINT, TOKEN_SUPER,
	TOKEN_RETURN, TOKEN_VAR, TOKEN_WHILE, TOKEN_THIS,
